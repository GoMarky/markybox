...
import { IBottomNavItem, noteBottomItems, workspaceBottomItems } from '@/app/views/composables/use-bottom-navigation-items';
import useBottomNav from '@/app/views/composables/use-bottom-navigation';
import useCodeSectionNavigation, { CodeSection } from '@/app/views/composables/useCodeSectionNavigation';
