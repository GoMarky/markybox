import { FileType, IWorkspaceFile, IRawWorkspaceFile } from '@/code/workspace/common/workspace-file';
import { nanoid } from 'nanoid';
import { isDefined, isUndefined, isUndefinedOrNull } from '@/base/types';
